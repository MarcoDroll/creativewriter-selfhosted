...
export function corsHeaders(origin: string): Record<string, string> {
  ...
  if (selfHosted) {
    return {
      ...
      'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-API-Key, X-Client-Name, X-Client-Version, Accept, anthropic-version, anthropic-beta, X-API-Token, X-License-Key, Prefer, X-Pipeline-Request-Id',
