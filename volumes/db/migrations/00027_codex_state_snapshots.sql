...
create table if not exists public.codex_entry_state_snapshots (
...
create index if not exists idx_cess_entry_id on public.codex_entry_state_snapshots(entry_id);
create index if not exists idx_cess_story_id on public.codex_entry_state_snapshots(story_id);
create index if not exists idx_cess_scene_id on public.codex_entry_state_snapshots(scene_id);
...
drop policy if exists "Users own their state snapshots" on public.codex_entry_state_snapshots;
...
create unique index if not exists idx_codex_entries_one_world_per_codex
