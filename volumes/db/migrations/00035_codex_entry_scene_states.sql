...
create table if not exists public.codex_entry_scene_states (
...
create index if not exists idx_cess_story on public.codex_entry_scene_states(story_id);
create index if not exists idx_cess_scene on public.codex_entry_scene_states(scene_id);
create index if not exists idx_cess_user  on public.codex_entry_scene_states(user_id);
...
drop policy if exists "cess_owner_all" on public.codex_entry_scene_states;
