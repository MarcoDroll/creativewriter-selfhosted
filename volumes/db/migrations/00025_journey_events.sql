...
CREATE TABLE IF NOT EXISTS journey_tracking_config (
...
DROP POLICY IF EXISTS journey_events_select_own ON journey_events;
CREATE POLICY journey_events_select_own ON journey_events
  FOR SELECT TO authenticated
  USING ((select auth.uid()) = user_id);

DROP POLICY IF EXISTS journey_tracking_config_select_own ON journey_tracking_config;
