...
DROP TRIGGER IF EXISTS trg_enforce_image_count_limit ON public.story_images;
...
DROP TRIGGER IF EXISTS trg_enforce_video_count_limit ON public.story_videos;
...
DROP TRIGGER IF EXISTS trg_enforce_background_count_limit ON public.custom_backgrounds;
